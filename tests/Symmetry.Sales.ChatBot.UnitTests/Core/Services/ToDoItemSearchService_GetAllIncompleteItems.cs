...
using Symmetry.Sales.ChatBot.Core.ProjectAggregate;
using Symmetry.Sales.ChatBot.Core.Services;
using Symmetry.Sales.ChatBot.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Symmetry.Sales.ChatBot.UnitTests.Core.Services
{
